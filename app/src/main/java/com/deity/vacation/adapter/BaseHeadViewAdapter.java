...
/**
 * Created by Deity on 2016/10/18.
 */

public class BaseHeadViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
     ...
     */
    public BaseHeadViewAdapter(RecyclerView.Adapter adapter) {
